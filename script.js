function seleccionPalabra(diccionario) {
    return diccionario[Math.floor(Math.random() * diccionario.length)];
}

let intentos = 6;
let diccionario = ['COMER', 'FELIZ', 'GATOS', 'JOVEN', 'PLAYA', 'LIBRO'];
let palabra = seleccionPalabra(diccionario);
...
function init() {
    palabra = seleccionPalabra(diccionario);
}
